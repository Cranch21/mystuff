...
class GameEnv:
    ...
    def _check_collision_or_terminal(self, row, col, reward, row_move_dir, col_move_dir):
        return self.__check_collision_or_terminal( row, col, reward, row_move_dir, col_move_dir)

    def check_collision_or_terminal_glide(self, row, col, reward, row_move_dir, col_move_dir):
        return self.__check_collision_or_terminal_glide( row, col, reward, row_move_dir, col_move_dir)

    def _check_gem_collected_or_goal_reached(self, row, col, gem_status):
        return self.__check_gem_collected_or_goal_reached( row, col, gem_status)
